...
#define MATCH_PSX_ADD16 0x8000002b
#define MASK_PSX_ADD16 0xfe00707f
#define MATCH_PSX_ADD8 0x2b
#define MASK_PSX_ADD8 0xfe00707f
#define MATCH_PSX_CEQ16 0xa800002b
#define MASK_PSX_CEQ16 0xfe00707f
#define MATCH_PSX_CEQ8 0x2800002b
#define MASK_PSX_CEQ8 0xfe00707f
#define MATCH_PSX_CGT16 0xbe00002b
#define MASK_PSX_CGT16 0xfe00707f
#define MATCH_PSX_CGT8 0x3e00002b
#define MASK_PSX_CGT8 0xfe00707f
#define MATCH_PSX_CGTU16 0xae00002b
#define MASK_PSX_CGTU16 0xfe00707f
#define MATCH_PSX_CGTU8 0x2e00002b
#define MASK_PSX_CGTU8 0xfe00707f
#define MATCH_PSX_CLE16 0xbc00002b
#define MASK_PSX_CLE16 0xfe00707f
#define MATCH_PSX_CLE8 0x3c00002b
#define MASK_PSX_CLE8 0xfe00707f
#define MATCH_PSX_CLEU16 0xac00002b
#define MASK_PSX_CLEU16 0xfe00707f
#define MATCH_PSX_CLEU8 0x2c00002b
#define MASK_PSX_CLEU8 0xfe00707f
#define MATCH_PSX_CLT16 0xba00002b
#define MASK_PSX_CLT16 0xfe00707f
#define MATCH_PSX_CLT8 0x3a00002b
#define MASK_PSX_CLT8 0xfe00707f
#define MATCH_PSX_CLTU16 0xaa00002b
#define MASK_PSX_CLTU16 0xfe00707f
#define MATCH_PSX_CLTU8 0x2a00002b
#define MASK_PSX_CLTU8 0xfe00707f
#define MATCH_PSX_CNE16 0xb800002b
#define MASK_PSX_CNE16 0xfe00707f
#define MATCH_PSX_CNE8 0x3800002b
#define MASK_PSX_CNE8 0xfe00707f
#define MATCH_PSX_DOT2D 0x4400002b
#define MASK_PSX_DOT2D 0xfe00707f
#define MATCH_PSX_KADD16 0x8c00002b
#define MASK_PSX_KADD16 0xfe00707f
#define MATCH_PSX_KADD8 0xc00002b
#define MASK_PSX_KADD8 0xfe00707f
#define MATCH_PSX_KSUB16 0x8e00002b
#define MASK_PSX_KSUB16 0xfe00707f
#define MATCH_PSX_KSUB8 0xe00002b
#define MASK_PSX_KSUB8 0xfe00707f
#define MATCH_PSX_KUADD16 0x8800002b
#define MASK_PSX_KUADD16 0xfe00707f
#define MATCH_PSX_KUADD8 0x800002b
#define MASK_PSX_KUADD8 0xfe00707f
#define MATCH_PSX_KUSUB16 0x8a00002b
#define MASK_PSX_KUSUB16 0xfe00707f
#define MATCH_PSX_KUSUB8 0xa00002b
#define MASK_PSX_KUSUB8 0xfe00707f
#define MATCH_PSX_MAX16 0xb000002b
#define MASK_PSX_MAX16 0xfe00707f
#define MATCH_PSX_MAX8 0x3000002b
#define MASK_PSX_MAX8 0xfe00707f
#define MATCH_PSX_MIN16 0xb200002b
#define MASK_PSX_MIN16 0xfe00707f
#define MATCH_PSX_MIN8 0x3200002b
#define MASK_PSX_MIN8 0xfe00707f
#define MATCH_PSX_MLH16 0x4200002b
#define MASK_PSX_MLH16 0xfe00707f
#define MATCH_PSX_MLL16 0x4000002b
#define MASK_PSX_MLL16 0xfe00707f
#define MATCH_PSX_PACK16 0x4800002b
#define MASK_PSX_PACK16 0xfe00707f
#define MATCH_PSX_PACK8 0x4e00002b
#define MASK_PSX_PACK8 0xfe00707f
#define MATCH_PSX_PERM8 0x4c00002b
#define MASK_PSX_PERM8 0xfe00707f
#define MATCH_PSX_ROL16 0xe600002b
#define MASK_PSX_ROL16 0xfe00707f
#define MATCH_PSX_ROL8 0x6600002b
#define MASK_PSX_ROL8 0xfe00707f
#define MATCH_PSX_ROR16 0xe400002b
#define MASK_PSX_ROR16 0xfe00707f
#define MATCH_PSX_ROR8 0x6400002b
#define MASK_PSX_ROR8 0xfe00707f
#define MATCH_PSX_SLL16 0xe000002b
#define MASK_PSX_SLL16 0xfe00707f
#define MATCH_PSX_SLL8 0x6000002b
#define MASK_PSX_SLL8 0xfe00707f
#define MATCH_PSX_SRA16 0xea00002b
#define MASK_PSX_SRA16 0xfe00707f
#define MATCH_PSX_SRA8 0x6a00002b
#define MASK_PSX_SRA8 0xfe00707f
#define MATCH_PSX_SRL16 0xe200002b
#define MASK_PSX_SRL16 0xfe00707f
#define MATCH_PSX_SRL8 0x6200002b
#define MASK_PSX_SRL8 0xfe00707f
#define MATCH_PSX_SUB16 0x8200002b
#define MASK_PSX_SUB16 0xfe00707f
#define MATCH_PSX_SUB8 0x200002b
#define MASK_PSX_SUB8 0xfe00707f
#define MATCH_PSX_UMAX16 0xa000002b
#define MASK_PSX_UMAX16 0xfe00707f
#define MATCH_PSX_UMAX8 0x2000002b
#define MASK_PSX_UMAX8 0xfe00707f
#define MATCH_PSX_UMIN16 0xa200002b
#define MASK_PSX_UMIN16 0xfe00707f
#define MATCH_PSX_UMIN8 0x2200002b
#define MASK_PSX_UMIN8 0xfe00707f
#define MATCH_PSX_USAD16 0x4a00002b
#define MASK_PSX_USAD16 0xfe00707f
#define MATCH_PSX_USAD8 0x4600002b
#define MASK_PSX_USAD8 0xfe00707f
...
/* XPSX instructions */
DECLARE_INSN(psx_add16, MATCH_PSX_ADD16, MASK_PSX_ADD16)
DECLARE_INSN(psx_add8, MATCH_PSX_ADD8, MASK_PSX_ADD8)
DECLARE_INSN(psx_ceq16, MATCH_PSX_CEQ16, MASK_PSX_CEQ16)
DECLARE_INSN(psx_ceq8, MATCH_PSX_CEQ8, MASK_PSX_CEQ8)
DECLARE_INSN(psx_cgt16, MATCH_PSX_CGT16, MASK_PSX_CGT16)
DECLARE_INSN(psx_cgt8, MATCH_PSX_CGT8, MASK_PSX_CGT8)
DECLARE_INSN(psx_cgtu16, MATCH_PSX_CGTU16, MASK_PSX_CGTU16)
DECLARE_INSN(psx_cgtu8, MATCH_PSX_CGTU8, MASK_PSX_CGTU8)
DECLARE_INSN(psx_cle16, MATCH_PSX_CLE16, MASK_PSX_CLE16)
DECLARE_INSN(psx_cle8, MATCH_PSX_CLE8, MASK_PSX_CLE8)
DECLARE_INSN(psx_cleu16, MATCH_PSX_CLEU16, MASK_PSX_CLEU16)
DECLARE_INSN(psx_cleu8, MATCH_PSX_CLEU8, MASK_PSX_CLEU8)
DECLARE_INSN(psx_clt16, MATCH_PSX_CLT16, MASK_PSX_CLT16)
DECLARE_INSN(psx_clt8, MATCH_PSX_CLT8, MASK_PSX_CLT8)
DECLARE_INSN(psx_cltu16, MATCH_PSX_CLTU16, MASK_PSX_CLTU16)
DECLARE_INSN(psx_cltu8, MATCH_PSX_CLTU8, MASK_PSX_CLTU8)
DECLARE_INSN(psx_cne16, MATCH_PSX_CNE16, MASK_PSX_CNE16)
DECLARE_INSN(psx_cne8, MATCH_PSX_CNE8, MASK_PSX_CNE8)
DECLARE_INSN(psx_dot2d, MATCH_PSX_DOT2D, MASK_PSX_DOT2D)
DECLARE_INSN(psx_kadd16, MATCH_PSX_KADD16, MASK_PSX_KADD16)
DECLARE_INSN(psx_kadd8, MATCH_PSX_KADD8, MASK_PSX_KADD8)
DECLARE_INSN(psx_ksub16, MATCH_PSX_KSUB16, MASK_PSX_KSUB16)
DECLARE_INSN(psx_ksub8, MATCH_PSX_KSUB8, MASK_PSX_KSUB8)
DECLARE_INSN(psx_kuadd16, MATCH_PSX_KUADD16, MASK_PSX_KUADD16)
DECLARE_INSN(psx_kuadd8, MATCH_PSX_KUADD8, MASK_PSX_KUADD8)
DECLARE_INSN(psx_kusub16, MATCH_PSX_KUSUB16, MASK_PSX_KUSUB16)
DECLARE_INSN(psx_kusub8, MATCH_PSX_KUSUB8, MASK_PSX_KUSUB8)
DECLARE_INSN(psx_max16, MATCH_PSX_MAX16, MASK_PSX_MAX16)
DECLARE_INSN(psx_max8, MATCH_PSX_MAX8, MASK_PSX_MAX8)
DECLARE_INSN(psx_min16, MATCH_PSX_MIN16, MASK_PSX_MIN16)
DECLARE_INSN(psx_min8, MATCH_PSX_MIN8, MASK_PSX_MIN8)
DECLARE_INSN(psx_mlh16, MATCH_PSX_MLH16, MASK_PSX_MLH16)
DECLARE_INSN(psx_mll16, MATCH_PSX_MLL16, MASK_PSX_MLL16)
DECLARE_INSN(psx_pack16, MATCH_PSX_PACK16, MASK_PSX_PACK16)
DECLARE_INSN(psx_pack8, MATCH_PSX_PACK8, MASK_PSX_PACK8)
DECLARE_INSN(psx_perm8, MATCH_PSX_PERM8, MASK_PSX_PERM8)
DECLARE_INSN(psx_rol16, MATCH_PSX_ROL16, MASK_PSX_ROL16)
DECLARE_INSN(psx_rol8, MATCH_PSX_ROL8, MASK_PSX_ROL8)
DECLARE_INSN(psx_ror16, MATCH_PSX_ROR16, MASK_PSX_ROR16)
DECLARE_INSN(psx_ror8, MATCH_PSX_ROR8, MASK_PSX_ROR8)
DECLARE_INSN(psx_sll16, MATCH_PSX_SLL16, MASK_PSX_SLL16)
DECLARE_INSN(psx_sll8, MATCH_PSX_SLL8, MASK_PSX_SLL8)
DECLARE_INSN(psx_sra16, MATCH_PSX_SRA16, MASK_PSX_SRA16)
DECLARE_INSN(psx_sra8, MATCH_PSX_SRA8, MASK_PSX_SRA8)
DECLARE_INSN(psx_srl16, MATCH_PSX_SRL16, MASK_PSX_SRL16)
DECLARE_INSN(psx_srl8, MATCH_PSX_SRL8, MASK_PSX_SRL8)
DECLARE_INSN(psx_sub16, MATCH_PSX_SUB16, MASK_PSX_SUB16)
DECLARE_INSN(psx_sub8, MATCH_PSX_SUB8, MASK_PSX_SUB8)
DECLARE_INSN(psx_umax16, MATCH_PSX_UMAX16, MASK_PSX_UMAX16)
DECLARE_INSN(psx_umax8, MATCH_PSX_UMAX8, MASK_PSX_UMAX8)
DECLARE_INSN(psx_umin16, MATCH_PSX_UMIN16, MASK_PSX_UMIN16)
DECLARE_INSN(psx_umin8, MATCH_PSX_UMIN8, MASK_PSX_UMIN8)
DECLARE_INSN(psx_usad16, MATCH_PSX_USAD16, MASK_PSX_USAD16)
DECLARE_INSN(psx_usad8, MATCH_PSX_USAD8, MASK_PSX_USAD8)
#endif /* DECLARE_INSN */
#ifdef DECLARE_CSR
